\documentclass[chaparabic,is,phd,10pt,single]{metu} 
% Change this
...
\director[prof]{Director of Institute} % Change this
% Head of Department
\headofdept[prof]{Head of Department} % Change this
%
% Supervisor : English and Turkish
\supervisor[assocprof]{Supervisor} % Change this
% \turkishsupervisor{  } %if you will hard-code the academic title
%
% Affiliation of Supervisor in English and possibly in Turkish
\departmentofsupervisor{Department, School} % Change this
...
\committeememberi[prof]{Committee Member 1} % Change this
\affiliationi{Department, School} % Change this
% Second committee member is always your supervisor
\committeememberii[assocprof]{Committee Member 2} % Change this
\affiliationii{Department, School} % Change this
...
\committeememberiii[assocprof]{Committee Member 3} % Change this
\affiliationiii{Department, School}  % Change this
...
% Acknowledgements   
\acknowledgments{
  Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here Acknowledgments here
} % Change this
